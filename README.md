...
想了解各 AI 编码平台的功能差异？查看 [AI 编码平台功能对比](docs/platform-comparison.md)，包含：

- Cursor、Windsurf、GitHub Copilot 等主流平台对比
- 核心功能矩阵（Agent 模式、项目级理解、多模型切换等）
- 定价对比与平台选择建议
- CodeBuddy CN 签到奖励功能介绍
